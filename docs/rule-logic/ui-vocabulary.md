...
````
![Rule Screenshot](../../static/img/readOnlyText.png)
...
```
![Rule Screenshot](../../static/img//text_area_rules.png) 
...
![Rule Screenshot](../../static/img//text_rule.png) 
</details>
...
```
![Rule Screenshot](../../static/img//number_rules.png)
...
![Rule Screenshot](../../static/img//number_rendered.png)
</details>
...
```
![Rule Screenshot](../../static/img//singlechoice.png) 
...
![Rule Screenshot](../../static/img//MultipleChoicesMultiSelect_rule.png)
...
![Rule Screenshot](../../static/img//yes_no_rule.png) 
...
```
![Rule Screenshot](../../static/img//multiple_expenses_rules.png) 
